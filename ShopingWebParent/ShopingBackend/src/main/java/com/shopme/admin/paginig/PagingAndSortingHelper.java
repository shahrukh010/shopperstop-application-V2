...
public class PagingAndSortingHelper {
	...
	public PagingAndSortingHelper(ModelAndViewContainer model, String lastName, String sortField, String sortDir,
			String keyword) {
	...
	public void updateModelAttributes(int pageNum, Page<?> page) {
		...
		long startCount = (pageNum - 1) * page.getSize() + 1;
		long endCount = startCount + page.getSize() - 1;
